...
# to do this we run the following from the CLI:
...
# - start a local agent by running 'prefect agent local start' in the CLI
# - (the local agent communicates between the server and the flow code)
